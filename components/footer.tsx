    ...
    <footer className="relative overflow-hidden bg-[linear-gradient(180deg,rgba(0,0,0,0.35)_0%,rgba(0,0,0,0.35)_100%)]">
      ...
      <div className="relative z-1 mx-auto max-w-[1360px] px-[clamp(20px,4vw,48px)] pt-20 pb-8 max-md:pt-14 max-md:pb-6">
                ...
                {NAV_LINKS.map((link) => (
                  <li key={link.id}>
                    <button
                      ...
                      className="group relative inline-flex items-center gap-[7px] rounded-lg text-[0.89rem] font-normal leading-[1.25] text-secondary transition-all duration-[180ms] hover:translate-x-0.5 hover:text-white/98 cursor-pointer"
                    >
                ...
                {SOCIAL_LINKS.map((link) => (
                  <li key={link.label}>
                    <a
                      ...
                      className="group relative inline-flex items-center gap-[7px] rounded-lg text-[0.89rem] font-normal leading-[1.25] text-secondary transition-all duration-[180ms] hover:translate-x-0.5 hover:text-white/98"
                    >
                      <link.icon className="h-[15px] w-[15px] shrink-0 opacity-50 transition-all duration-300 group-hover:text-accent group-hover:opacity-100" />
                      {link.label}
                    </a>
        ...
        <div className="relative text-center">
          <div className="mb-5 h-px w-full bg-[linear-gradient(90deg,transparent,rgba(242,242,242,0.18),transparent)] opacity-75" />
          <div className="flex items-center justify-between gap-3">
            <p className="text-[0.73rem] tracking-[0.45px] text-white/88">
              &copy; {new Date().getFullYear()} Pavlo Popovych. All rights reserved.
            </p>
            <p className="text-[0.74rem] text-muted opacity-50">
