...
export function initNetworkCanvas(canvas, heroSelector) {
    ...
    (function() {
      ...
      try {
        ...
        if (testCanvas.getContext && testCanvas.getContext('2d')) {
          ...
          if (avifSupported) candidateSources.push('/images/cw-meta.avif');
          if (webpSupported) candidateSources.push('/images/cw-meta.webp');
        }
      } catch (_) {
        // Ignore codec detection issues and rely on fallback list below.
      }
      candidateSources.push('/images/cw-meta.webp', '/images/cw-meta.jpg');
